...
def test_provenance_names_every_fixture_model_prompt_and_rubric_by_hash_or_version(
    ...
    assert set(p.fixtures) == {
        ...
        "debrief-refusal-cases.json",
        "class-analysis-refusal-cases.json",
        "weekly-report-refusal-cases.json",
        "monthly-report-refusal-cases.json",
        "practice-review-refusal-cases.json",
        "interview-follow-up-cases.json",
    }
