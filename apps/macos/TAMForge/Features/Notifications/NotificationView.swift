...
private struct NotificationListView: View {
    ...
    private var content: some View {
        ...
        case let .content(page), let .partial(page), let .stale(page):
            notificationItems(page.allowedItems, stale: isStale)
        case let .offline(page):
            if let page { notificationItems(page.allowedItems, stale: true) }
    ...
    private func notificationItems(_ items: [TAMForgeNotification], stale: Bool) -> some View {
